  ...
  return (
    <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  <span className="font-medium block">Review Verifications</span>
                  <span className="text-sm text-muted-foreground">Pending mentor applications</span>
                </div>
              </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  ...
                  <span className="text-sm text-muted-foreground">User accounts and permissions</span>
                </div>
              </div>
              <ChevronRight className="h-4 w-4 text-muted-foreground" />
            </button>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  <span className="font-medium block">Monitor Sessions</span>
                  <span className="text-sm text-muted-foreground">Active and scheduled sessions</span>
                </div>
              </div>
              <ChevronRight className="h-4 w-4 text-muted-foreground" />
            </button>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  <span className="font-medium block">View Analytics</span>
                  <span className="text-sm text-muted-foreground">Platform performance metrics</span>
                </div>
              </div>
              <ChevronRight className="h-4 w-4 text-muted-foreground" />
            </button>
      ...
      <div className="bg-card rounded-lg p-6 border border-border">
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-3 p-3 hover:bg-muted rounded-md">
